...
export const HERO_SLIDES: HeroSlide[] = [
  {
    title: "Крашеная доска с заводской покраской — производитель в Истре",
    subtitle:
      "Покраска на автоматической линии: шлифовка, 2 слоя ЛКМ, контроль сушки. Готовый материал под монтаж. Доставка в Москву и регионы.",
