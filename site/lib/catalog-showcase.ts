...
export const CATALOG_SHOWCASE: CatalogShowcaseItem[] = [
  {
    ...
    tagline:
      "Она приходит на объект — и сразу становится частью вашего дома. Без пыли. Без подтёков. Без компромиссов.",
  ...
  },
  {
    ...
    tagline: "Строганая северная сосна с трёхслойным UF-покрытием для фасадов",
    ...
    specs: [
      ...
      { label: "Длина", value: "6000 мм" },
      { label: "Покрытие", value: "Трёхслойное UF-стойкое (грунт + 2 слоя финиша)" },
    ],
  },
  {
