...
const advantages = [
  {
    title: "Трёхслойное покрытие",
    text: "Грунт и два финишных слоя на автоматической линии. Толщина сухого слоя — по паспорту системы Sirca, Teknos или Tikkurila.",
  },
  {
    title: "Производительность",
    text: "До 912 м² готовой доски за смену. Типовой заказ 80–150 м² — от 5 рабочих дней с момента согласования цвета.",
  },
  {
    title: "Сушка и режим",
    text: "Температура в камере +18…+22 °C, влажность воздуха 45–65 %. Межслойная пауза 4–8 часов — не «на глаз», а по регламенту.",
  },
  {
    title: "Подготовка древесины",
    text: "Шлифовка зерном P120–P180 или браширование до покраски. Влажность пиломатериала 10–14 % перед нанесением.",
  },
  {
    title: "Официальный дилер Sirca",
    text: "Итальянские лакокрасочные материалы и колеровка по каталогам RAL, NCS, BIOFA, Osmo. Подбор оттенка по образцу — бесплатно.",
  },
  {
    title: "Гарантия 3 года",
    text: "На покрытие и обработку при соблюдении условий монтажа. Гарантийный талон выдаём при отгрузке со склада в Истре.",
  },
];
      ...
      <div className="container-content grid gap-10 lg:grid-cols-[minmax(0,420px)_1fr] lg:gap-14">
        <div>
          <h2 className="text-2xl font-semibold leading-tight text-white sm:text-3xl lg:text-[34px]">
            Заводская покраска доски: вагонка, планкен, фасад, терраса
          </h2>
          <p className="mt-4 text-base leading-relaxed text-white/85">
            Цех в Истре — 65 км от МКАД по Новорижскому шоссе. Красим вагонку, планкен,
            скандинавскую и фасадную доску, имитацию бруса, террасу и палубу. Цены в каталоге —
            от 1 436 до 2 800 руб/м² с покраской, в зависимости от профиля и породы.
          </p>
        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div className="max-w-3xl">
            <h2 className="section-title">
              Каталог: 8 групп продукции, сорта от АВ до Экстра, длина до 6 000 мм
            </h2>
          </div>
