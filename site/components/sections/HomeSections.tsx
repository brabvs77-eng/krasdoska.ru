...
const advantageIcons = [
  ...
  <svg key="i5" {...iconProps}>
    <path d="M12 4.2c4.2 0 7.6 3 7.6 6.8 0 2.2-1.1 4.2-2.9 5.5-.4.3-.4.9 0 1.2 1 .8 1.7 2 1.7 3.3 0 .4-.4.7-.8.6-1.4-.4-2.6-1.1-3.5-2.1-.3-.3-.8-.3-1.1 0-.9 1-2.1 1.7-3.5 2.1-.4.1-.8-.2-.8-.6 0-1.3.7-2.5 1.7-3.3.4-.3.4-.9 0-1.2C6.5 15.2 5.4 13.2 5.4 11c0-3.8 3.4-6.8 6.6-6.8Z" />
    <circle cx="12" cy="11" r="1.2" />
    <path d="M12 7.2c2.3 0 4.2 1.6 4.2 3.6S14.3 14.4 12 14.4 7.8 12.8 7.8 10.8 9.7 7.2 12 7.2Z" />
    <path d="M9.2 9.2c.6-.7 1.5-1.1 2.5-1.1M14.8 12.4c-.5.6-1.3 1-2.2 1" />
  </svg>,
];
