...
| Тип | Кол-во | Статус |
|-----|-------:|--------|
| Статьи блога (`site/content/blog/`) | **57** | Опубликованы (фазы 1–5) |
...
| # | Тема / slug (предлож.) | Зачем | Связка |
|---|------------------------|-------|--------|
| 1 | `krashenaya-imitaciya-brusa-kupit` | GSC: коммерция, 0 кликов | → `/katalog/krashenaja-imitacija-brusa/` |
| 2 | `krashenyy-planken-kupit-moskva` | 146 показов на планкен | → `/katalog/planken/` |
| 3 | `krashenaya-fasadnaya-doska` | Фасадный кластер | → `/katalog/fasadnaja-doska/` |
| 4 | `blok-haus-krashenyy` | Категория без статей | → каталог блок-хаус |
