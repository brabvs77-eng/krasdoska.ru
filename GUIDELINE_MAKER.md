# GUIDELINE_MAKER.md — интервью по голосу бренда «Крашеная доска»

Your job is to interview the user and build or update `GUIDELINE.md` for the **Крашеная доска** brand ([krashenayadoska.ru](https://krashenayadoska.ru/)) — factory lumber painting in a professional workshop. Claude uses this file as its writing bible for every article draft.
